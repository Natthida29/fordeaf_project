...
class CustomSearch extends SearchDelegate{
    ...
    'ทำแท้ง','เอดส์','เกิดอาการแพ้','ตามัว','ทวารหนัก','ปวดที่แขน','งดรับประทานอาหาร','สายตาเอียง','ท้อง','กระเพาะปัสสาวะ',
    'แผลพุพอง','ตาพร่า','แสบตา','แสบจมูก','ปวดแสบท้อง','กลืนไม่ลง','นอนไม่หลับ','เป็นหวัด','ตาแดง','ท้องผูก',
    'ไอ','ท้องเสีย','มึนหัว','เวียนหัว','จาม','กินอาหารเหล่านั้นไม่ได้','โรคลมบ้าหมู','เจ็บ','การอุดฟัน','ท้องอืด',
    'เป็นไข้','ตะคริว','ปวดหัว','หัวใจเต้นแรง','ความดันโลหิตสูง','ไข้สูง','ปวดขากรรไกร','มองไม่เห็นทีละน้อย','ตัวสั่น','แน่นหน้าอก',
    'ป่วย','น้ำมูก','คลื่นไส้','ปวดท้อง','กระเพาะอาหาร','เครียด','บวม','เมื่อย','คัน','ตาแฉะ',
    'เบื่ออาหาร','แพ้ยา','แพ้อากาศ','แพ้อาหาร','ภูมิแพ้','หนาวๆร้อนๆ','หอบ','เหน็บชา','เหนื่อยง่าย','อาเจียน',
  ];
          ...
          onTap: () {
            if (result == 'ทำแท้ง') {
              ...
              showDialog(
                context: context,
                builder: (context) => AlertDialog(
                  content: Image.asset('assets/symptom/high-blood-pressure.gif'),
                ),
              );
